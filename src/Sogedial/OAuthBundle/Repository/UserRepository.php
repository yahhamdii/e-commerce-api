...
namespace Sogedial\OAuthBundle\Repository;
 ...
 */
class UserRepository extends \Sogedial\ApiBundle\Repository\EntityRepository {
    ...
    protected function getAcl(QueryBuilder $qb): void {
        ...
        $qb->leftJoin(UserCustomer::class, 'customers', 'WITH', $this->getAlias() . '.id=customers.id')
                ->leftJoin('customers.client', 'client_customers')
                ->leftJoin(UserCommercial::class, 'commercials', 'WITH', $this->getAlias() . '.id=commercials.id')
                ->leftJoin('commercials.clients', 'client_commercial')
                ->leftJoin(UserAdmin::class, 'admins', 'WITH', $this->getAlias() . '.id=admins.id');
